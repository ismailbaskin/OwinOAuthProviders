...
{
    public class TrtIdAuthenticationHandler : AuthenticationHandler<TrtIdAuthenticationOptions>
    {
        private const string XmlSchemaString = "http://www.w3.org/2001/XMLSchema#string";
        private const string TokenEndpoint = "http://id.trt.net.tr/access_token";
        private const string UserInfoEndpoint = "http://id.trt.net.tr/api/profile";

        private readonly ILogger _logger;
        private readonly HttpClient _httpClient;

        public TrtIdAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new TrtIdAuthenticatedContext(Context, user, accessToken, refreshToken, expiresIn)
                {
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            ...
            var context = new TrtIdReturnEndpointContext(Context, ticket)
            {
